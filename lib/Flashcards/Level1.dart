...
class _Level1 extends State<Level1> {
  List<Map<String, String>> _flashcards = [
    {'question': 'Merah', 'answer': 'Red', 'img': 'merah'},
    {'question': 'Hijau', 'answer': 'Green', 'img': 'hijau'},
    {'question': 'Biru', 'answer': 'Blue', 'img': 'biru'},
    {'question': 'Kuning', 'answer': 'Yellow', 'img': 'kuning'},
    {'question': 'Hitam', 'answer': 'Black', 'img': 'hitam'},
    {'question': 'Putih', 'answer': 'White', 'img': 'putih'},
    {'question': 'Oranye', 'answer': 'Orange', 'img': 'orange'},
    {'question': 'Merah Muda', 'answer': 'Pink', 'img': 'pink'},
    {'question': 'Ungu', 'answer': 'Purple', 'img': 'ungu'},
    {'question': 'Abu', 'answer': 'Grey', 'img': 'abu'},
  ];
  ...
  void showSuccessDialog() {
    AwesomeDialog(
      ...
      btnOkOnPress: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => Quiz(level: 1)),
        );
      },
    ).show();
  }
