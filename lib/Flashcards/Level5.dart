...
class Level5 extends StatefulWidget {
  ...
  @override
  State<Level5> createState() => _Level5();
}

class _Level5 extends State<Level5> {
  List<Map<String, String>> _flashcards = [
    {'question': 'Buku', 'answer': 'Book', 'img': 'book'},
    {'question': 'Pensil', 'answer': 'Pencil', 'img': 'pencil'},
    {'question': 'Ransel', 'answer': 'Backpack', 'img': 'backpack'},
    {'question': 'Jam', 'answer': 'Clock', 'img': 'clock'},
    {'question': 'Kursi', 'answer': 'Chair', 'img': 'chair'},
    {'question': 'Meja', 'answer': 'Table', 'img': 'table'},
    {'question': 'Sepeda', 'answer': 'Bicycle', 'img': 'bicycle'},
    {'question': 'Kasur', 'answer': 'Bed', 'img': 'bed'},
    {'question': 'Boneka', 'answer': 'Doll', 'img': 'doll'},
    {'question': 'Payung', 'answer': 'Umbrella', 'img': 'umbrella'},
  ];
  ...
  void showSuccessDialog() {
    AwesomeDialog(
      ...
      btnOkOnPress: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => Quiz(level: 5)),
        );
      },
    ).show();
  }
